...
receive_pipe="/tmp/ironbar-ddc-module-rx"
step=5
...
ddcutil_fast() {
    ...
    ddcutil --noverify --bus 11 --sleep-multiplier .03 "$@" 2>/dev/null
}
...
# in case ironbar restarted the script after restarting/replugging a monitor
