...
}:
{
  ...
  #         "Mod+Grave".action = focus-workspace "EXTE";
  ...
  #         "Mod+Shift+Grave".action.move-window-to-workspace = "EXTE";
  ...
  #         };
  #         "Mod+M" = {
  #           action = sh "${config.home.homeDirectory}/nixos/home/misc/scripts/shutdown_reboot_lock.sh";
