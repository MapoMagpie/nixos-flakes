...
RowLayout {
    ...
    case 0:
        ...
        break;
    case 1:
        (batCharging) ? chargeIcon : balancedIcon;
        break;
    case 2:
        "";
        break;
    ...
    Component.onCompleted: () => {
        console.log("upower completed: devices:", UPower.devices.values.length);
        console.log("upower completed: batPercentage:", UPower.displayDevice.percentage);
    }
